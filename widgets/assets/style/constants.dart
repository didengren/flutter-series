...
class AppColors {
  ...
  static const AppBarColor = 0xff3087FF;
  ...
  static const IndicatorColor = 0xFFFFFFFF;
  static const MaterialColor primarySwatch = const MaterialColor(
    AppBarColor,
    const <int, Color>{
      50: const Color(AppBarColor),
      100: const Color(AppBarColor),
      200: const Color(AppBarColor),
      300: const Color(AppBarColor),
      400: const Color(AppBarColor),
      500: const Color(AppBarColor),
      600: const Color(AppBarColor),
      700: const Color(AppBarColor),
      800: const Color(AppBarColor),
      900: const Color(AppBarColor),
    }
  );
}
